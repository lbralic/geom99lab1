...
### You must enable GitHub pages to view HTML documents at the url `lbralic.github.io/geom99lab1/`. 
...
Now your repository will be accessible under GitHub Pages (an HTML Web Server) at `https://lbralic.github.io/geom99lab1` where `lbralic` is your GitHub account username and the repository name is `geom99lab1`. Note you must type this manually into the URL above, or better yet, modify the ReadMe.md to change [username] to be your actual username! 
